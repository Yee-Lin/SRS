...
#define Emergency_FRONT_Pin GPIO_PIN_1
#define Emergency_FRONT_GPIO_Port GPIOB
#define Emergency_REAR_Pin GPIO_PIN_2
#define Emergency_REAR_GPIO_Port GPIOB
...
#define EPS_FRONT_Pin GPIO_PIN_11
#define EPS_FRONT_GPIO_Port GPIOE
#define EPS_REAR_Pin GPIO_PIN_12
#define EPS_REAR_GPIO_Port GPIOE
